...
#include "target/core-v-mcu/include/core_pulp.h"              /* Core Peripheral Access Layer */
...
/* ----------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------- */
// #include "hal/include/hal_gpio_periph.h"
...
// #include "hal/include/hal_udma_core_periph.h"
/* ----------------------------------------------------------------------------
   -- UDMA Register Masks
   ---------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------- */
//#include "hal/include/hal_spi_periph.h"


/* ----------------------------------------------------------------------------
   -- HYPERBUS Peripheral Access Layer
   ---------------------------------------------------------------------------- */
#include "target/core-v-mcu/include/core-v-mcu-memory-map.h"
...
/* ----------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------- */
//#include "hal/include/hal_uart_periph.h"
...
/* ----------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------- */
//#include "hal/include/hal_i2c_periph.h"
...
/* ----------------------------------------------------------------------------
   -- SOC_CTRL Peripheral
   ---------------------------------------------------------------------------- */
//#include "hal/include/hal_soc_ctrl_periph.h"
...
/* ----------------------------------------------------------------------------
   -- PWM Peripheral
   ---------------------------------------------------------------------------- */
//#include "hal/include/hal_pwm_periph.h"
//#include "hal/include/hal_pwm_ctrl_periph.h"
