...
#define UDMA_CH_ADDR_UART       (0x1A102000 + 1 * UDMA_CH_SIZE)
#define UDMA_UART_ID(id)        (0 + id)
#define UDMA_CH_ADDR_UART0      (0x1A102000 + 1 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_UART1      (0x1A102000 + 2 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_QSPIM      (0x1A102000 + 3 * UDMA_CH_SIZE)
#define UDMA_QSPIM_ID(id)       (2 + id)
#define UDMA_CH_ADDR_QSPIM0     (0x1A102000 + 3 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_QSPIM1     (0x1A102000 + 4 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2CM       (0x1A102000 + 5 * UDMA_CH_SIZE)
#define UDMA_I2CM_ID(id)        (4 + id)
#define UDMA_CH_ADDR_I2CM0      (0x1A102000 + 5 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2CM1      (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2SC       (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_I2SC_ID(id)        (6 + id)
#define UDMA_CH_ADDR_I2SC0      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_CSI2       (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CSI2_ID(id)        (6 + id)
#define UDMA_CH_ADDR_CSI20      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_HYPER      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_HYPER_ID(id)       (6 + id)
#define UDMA_CH_ADDR_HYPER0     (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_SDIO       (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_SDIO_ID(id)        (6 + id)
#define UDMA_CH_ADDR_SDIO0      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_CAM        (0x1A102000 + 8 * UDMA_CH_SIZE)
#define UDMA_CAM_ID(id)         (7 + id)
#define UDMA_CH_ADDR_CAM0       (0x1A102000 + 8 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_JTAG       (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_JTAG_ID(id)        (8 + id)
#define UDMA_CH_ADDR_JTAG0      (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_MRAM       (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_MRAM_ID(id)        (8 + id)
#define UDMA_CH_ADDR_MRAM0      (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_FILTER     (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_FILTER_ID(id)      (8 + id)
#define UDMA_CH_ADDR_FILTER0    (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_FPGA       (0x1A102000 + 10 * UDMA_CH_SIZE)
#define UDMA_FPGA_ID(id)        (9 + id)
#define UDMA_CH_ADDR_FPGA0      (0x1A102000 + 10 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_EXT_PER    (0x1A102000 + 10 * UDMA_CH_SIZE)
#define UDMA_EXT_PER_ID(id)     (9 + id)
#define UDMA_CH_ADDR_EXT_PER0   (0x1A102000 + 10 * UDMA_CH_SIZE)
...
#define UDMA_QSPIM_ID(id)       (2 + id)
#define UDMA_CH_ADDR_QSPIM0     (0x1A102000 + 3 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2CM       (0x1A102000 + 4 * UDMA_CH_SIZE)
#define UDMA_I2CM_ID(id)        (3 + id)
#define UDMA_CH_ADDR_I2CM0      (0x1A102000 + 4 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2CM1      (0x1A102000 + 5 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_I2SC       (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_I2SC_ID(id)        (5 + id)
#define UDMA_CH_ADDR_I2SC0      (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_CSI2       (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CSI2_ID(id)        (5 + id)
#define UDMA_CH_ADDR_CSI20      (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_HYPER      (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_HYPER_ID(id)       (5 + id)
#define UDMA_CH_ADDR_HYPER0     (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_SDIO       (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_SDIO_ID(id)        (5 + id)
#define UDMA_CH_ADDR_SDIO0      (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_CAM        (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CAM_ID(id)         (6 + id)
#define UDMA_CH_ADDR_CAM0       (0x1A102000 + 6 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_JTAG       (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_JTAG_ID(id)        (6 + id)
#define UDMA_CH_ADDR_JTAG0      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_MRAM       (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_MRAM_ID(id)        (6 + id)
#define UDMA_CH_ADDR_MRAM0      (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_FILTER     (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_FILTER_ID(id)      (6 + id)
#define UDMA_CH_ADDR_FILTER0    (0x1A102000 + 7 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_FPGA       (0x1A102000 + 8 * UDMA_CH_SIZE)
#define UDMA_FPGA_ID(id)        (7 + id)
#define UDMA_CH_ADDR_FPGA0      (0x1A102000 + 8 * UDMA_CH_SIZE)
#define UDMA_CH_ADDR_EXT_PER    (0x1A102000 + 9 * UDMA_CH_SIZE)
#define UDMA_EXT_PER_ID(id)     (8 + id)
#define UDMA_CH_ADDR_EXT_PER0   (0x1A102000 + 9 * UDMA_CH_SIZE)
